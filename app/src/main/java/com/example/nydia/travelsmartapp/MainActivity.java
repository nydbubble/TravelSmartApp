...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    private TravelMode defaultTravelMode = TravelMode.DRIVING;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //getDeviceLocation();
        /*LatLng changiairport = new LatLng(1.364731, 103.991595);
        mMap.addMarker(new MarkerOptions().position(changiairport).title("Marker in Barcelona"));

        LatLng ntu = new LatLng(1.348428, 103.683113);
        mMap.addMarker(new MarkerOptions().position(ntu).title("Marker in Madrid"));
        ...
        String changiairportstr = changiairport.latitude +", " + changiairport.longitude;


        //Execute Directions API request
        GeoApiContext context = getGeoContext();
        DirectionsApiRequest req = DirectionsApi.getDirections(context, changiairportstr, "1.348428, 103.683113", TravelMode.DRIVING);
        try {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(changiairport, 10));*/
    }


    private void plotDirections(DirectionsResult directions){
        if(directions!= null){
            addPolyline(directions, mMap);
            positionCamera(directions.routes[overview], mMap);
            addMarkersToMap(directions, mMap);
        }
    }
    ...
    private void addMarkersToMap(DirectionsResult results, GoogleMap mMap) {
        ...
        originMarker = mMap.addMarker(new MarkerOptions().position(new LatLng(results.routes[overview].legs[overview].startLocation.lat,results.routes[overview].legs[overview].startLocation.lng)).title(results.routes[overview].legs[overview].startAddress));
        destinationMarker = mMap.addMarker(new MarkerOptions().position(new LatLng(results.routes[overview].legs[overview].endLocation.lat,results.routes[overview].legs[overview].endLocation.lng)).title(results.routes[overview].legs[overview].endAddress).snippet(getEndLocationTitle(results)));
    }
